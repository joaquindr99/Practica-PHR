...
REM
REM Generated by Vivado on Sun Jun 19 19:48:43 +0200 2022
...
echo "xvhdl --incr --relax -prj Pruebas_vhdl.prj"
call xvhdl  --incr --relax -prj Pruebas_vhdl.prj -log xvhdl.log
